...
class Messages:
    ...
    INVALID_EMAIL = [{"message": _("Invalid email entered."), "code": "invalid_email"}]
    INVALID_USERNAME = [{"message": _("Invalid username entered."), "code": "invalid_username"}]
    INVALID_CREDENTIALS = [
        {
    ...
    ATTEMPTS_EXCEEDED = [{
        "message": _('You can not have more than {} attempts per day, please try again tomorrow').format(getattr(settings, 'LOGIN_ATTEMPTS', 10)),
