...
class InvalidUsername(GraphQLAuthError):
    default_message = _("Invalid username.")


class InvalidEmail(GraphQLAuthError):
    default_message = _("Invalid email.")
...
class UsernameAlreadyInUse(GraphQLAuthError):
    default_message = _("This username is already in use.")
...
class SessionExpired(GraphQLAuthError):
    default_message = _("Session expired, please re-login.")
